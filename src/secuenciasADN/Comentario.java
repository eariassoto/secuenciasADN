...
public class Comentario{
 ...
 private String tipo, descripcion, nombreAutor, apellAutor, email, referencia, baseDatos, linkBD;
 ...
 public Comentario(int i, int f, int id, Calendar fe, String t, String d, String n, String a, String e, String r, String bD, String l){
   usado = true;
   inicio = i;
   fin = f;
   idCaso = id;
          ...
          this.inicio = comentario.inicio;
            ...
            if(comentario.inicio >= this.inicio){
                if(comentarioSiguiente == null)
                    ...
                    while((tmp.inicio <= comentario.inicio) && (tmp.comentarioSiguiente != null) && (!insertado)){
                        if(tmp.comentarioSiguiente.inicio < comentario.inicio)
                            tmp = tmp.comentarioSiguiente;
                        else{
                            tmp.comentarioSiguiente = new Comentario(comentario, tmp, tmp.comentarioSiguiente);
